...
static_assert(alignof(FFoliageFilterStruct) == 0x000004, "Wrong alignment on FFoliageFilterStruct");
static_assert(sizeof(FFoliageFilterStruct) == 0x00000C, "Wrong size on FFoliageFilterStruct");
static_assert(offsetof(FFoliageFilterStruct, Name) == 0x000000, "Member 'FFoliageFilterStruct::Name' has a wrong offset!");
static_assert(offsetof(FFoliageFilterStruct, State) == 0x000008, "Member 'FFoliageFilterStruct::State' has a wrong offset!");
