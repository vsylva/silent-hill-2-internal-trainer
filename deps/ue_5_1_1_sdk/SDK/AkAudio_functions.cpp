...
// bool                                    bAllowPositionTracking                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

int32 UAkGameObject::PostAkEvent(class UAkAudioEvent* AkEvent, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, const class FString& InEventName, bool bAllowPositionTracking)
{
	...
	Parms.bAllowPositionTracking = bAllowPositionTracking;
...
int32 UAkGameObject::PostAssociatedAkEvent(int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, bool bAllowPositionTracking)
{
	static class UFunction* Func = nullptr;
...
float UAkComponent::GetPlaybackTime(int32 PlayingID)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkComponent", "GetPlaybackTime");

	Params::AkComponent_GetPlaybackTime Parms{};
...
int32 UAkComponent::PostAkEventAndWaitForEnd(class UAkAudioEvent* AkEvent, const class FString& In_EventName, const struct FLatentActionInfo& LatentInfo, bool bAllowPositionTracking)
{
	static class UFunction* Func = nullptr;
...
bool UAkPortalComponent::PortalHasAnyRoomContext() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkPortalComponent", "PortalHasAnyRoomContext");

	Params::AkPortalComponent_PortalHasAnyRoomContext Parms{};
...
// Function AkAudio.AkAmbientSound.AsyncPlayCompletion
// (Final, Native, Public)
...
void AAkAmbientSound::AsyncPlayCompletion()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkAmbientSound", "AsyncPlayCompletion");
...
// Function AkAudio.AkAmbientSound.StartAmbientSoundAsync
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
...
void AAkAmbientSound::StartAmbientSoundAsync()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkAmbientSound", "StartAmbientSoundAsync");
...
int32 UAkAudioEvent::PostOnComponentAndWait(class UAkComponent* Component, const bool bStopWhenAttachedObjectDestroyed, const struct FLatentActionInfo& LatentActionInfo, bool bAllowPositionTracking)
{
	static class UFunction* Func = nullptr;
...
int32 UAkGameplayStatics::CheckPadHeadphonesStatus()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "CheckPadHeadphonesStatus");

	Params::AkGameplayStatics_CheckPadHeadphonesStatus Parms{};
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UAkComponent*                     In_pComponent                                          (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
int32 UAkGameplayStatics::ComponentSeekOnEvent(class UAkComponent* In_pComponent, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "ComponentSeekOnEvent");

	Params::AkGameplayStatics_ComponentSeekOnEvent Parms{};
...
// struct FVector                          Location                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EAttachLocation                         LocationType                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   CreatedComponentOcclusionRefreshInterval               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bCreatedComponentAutoDestroy                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UAkComponent*                     ReturnValue                                            (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UAkComponent* UAkGameplayStatics::GetAkComponentEx(class USceneComponent* AttachToComponent, bool* ComponentCreated, class FName AttachPointName, const struct FVector& Location, EAttachLocation LocationType, float CreatedComponentOcclusionRefreshInterval, bool bCreatedComponentAutoDestroy)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "GetAkComponentEx");

	Params::AkGameplayStatics_GetAkComponentEx Parms{};

	Parms.AttachToComponent = AttachToComponent;
	Parms.AttachPointName = AttachPointName;
	Parms.Location = std::move(Location);
	Parms.LocationType = LocationType;
	Parms.CreatedComponentOcclusionRefreshInterval = CreatedComponentOcclusionRefreshInterval;
	Parms.bCreatedComponentAutoDestroy = bCreatedComponentAutoDestroy;
...
int32 UAkGameplayStatics::GetSampleRate()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "GetSampleRate");

	Params::AkGameplayStatics_GetSampleRate Parms{};
...
bool UAkGameplayStatics::RenderNextNonRealtimeAudioFrame()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "RenderNextNonRealtimeAudioFrame");

	Params::AkGameplayStatics_RenderNextNonRealtimeAudioFrame Parms{};
...
int32 UAkGameplayStatics::SeekOnEvent(const class FString& In_EventName, class UAkComponent* In_pComponent, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID)
{
	static class UFunction* Func = nullptr;
...
bool UAkGameplayStatics::SetOfflineRendering(bool bEnable)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SetOfflineRendering");

	Params::AkGameplayStatics_SetOfflineRendering Parms{};
...
// (Final, BlueprintCosmetic, Native, Static, Public, BlueprintCallable)
// Parameters:
// float                                   FrameTimeInSeconds                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UAkGameplayStatics::SetOfflineRenderingFrameTime(float FrameTimeInSeconds)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SetOfflineRenderingFrameTime");

	Params::AkGameplayStatics_SetOfflineRenderingFrameTime Parms{};

	Parms.FrameTimeInSeconds = FrameTimeInSeconds;
...
void UAkGameplayStatics::SetRTPCValueByPlayID(const class FString& RTPCName, float RTPCValue, int32 PlayID, int32 InterpolationTimeMs)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SetRTPCValueByPlayID");

	Params::AkGameplayStatics_SetRTPCValueByPlayID Parms{};
...
class UAkComponent* UAkGameplayStatics::SpawnAkComponentAtLocation(class UObject* WorldContextObject, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking)
{
	static class UFunction* Func = nullptr;
...
class UAkComponent* UAkGameplayStatics::SpawnAkComponentAtLocationEx(class UObject* WorldContextObject, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SpawnAkComponentAtLocationEx");

	Params::AkGameplayStatics_SpawnAkComponentAtLocationEx Parms{};
...
// (Final, BlueprintCosmetic, Native, Static, Public, HasDefaults, BlueprintCallable)
// Parameters:
// class USceneComponent*                  BaseComponent                                          (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UAkAudioEvent*                    AkEvent                                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVector                          Location                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FRotator                         Orientation                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// bool                                    AutoPost                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// bool                                    bAllowPositionTracking                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   OcclusionRefreshInterval                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UAkComponent*                     ReturnValue                                            (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UAkComponent* UAkGameplayStatics::SpawnAkComponentAttachedEx(class USceneComponent* BaseComponent, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SpawnAkComponentAttachedEx");

	Params::AkGameplayStatics_SpawnAkComponentAttachedEx Parms{};
...
// Function AkAudio.AkRoomComponent.AsyncPlayCompletion
// (Final, Native, Public)
...
void UAkRoomComponent::AsyncPlayCompletion()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AkRoomComponent", "AsyncPlayCompletion");
