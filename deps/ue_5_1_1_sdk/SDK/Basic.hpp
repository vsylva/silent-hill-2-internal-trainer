...
namespace Offsets
{
	constexpr int32 GObjects          = 0x081308B0;
	constexpr int32 AppendString      = 0x02CF1080;
	constexpr int32 GNames            = 0x080911C0;
	constexpr int32 GWorld            = 0x0829F2F8;
	constexpr int32 ProcessEvent      = 0x02E75E40;
