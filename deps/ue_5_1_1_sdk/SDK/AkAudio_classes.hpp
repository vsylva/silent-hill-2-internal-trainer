...
public:
	int32 PostAkEvent(class UAkAudioEvent* AkEvent, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, const class FString& InEventName, bool bAllowPositionTracking);
	...
	int32 PostAssociatedAkEvent(int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, bool bAllowPositionTracking);
...
public:
	...
	bool                                          OcclusionIgnorePawnAttachedActors;                 // 0x0075(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             DefaultFitToGeometryCollisionChannel;              // 0x0076(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TMap<float, TSoftObjectPtr<class UAkAuxBus>>  EnvironmentDecayAuxBusMap;                         // 0x0100(0x0050)(Edit, Config, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	TSoftObjectPtr<class UAkRtpc>                 HFDampingRTPC;                                     // 0x0180(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkRtpc>                 DecayEstimateRTPC;                                 // 0x01B0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkRtpc>                 TimeToFirstReflectionRTPC;                         // 0x01E0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkAudioEvent>           AudioInputEvent;                                   // 0x0210(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSoftObjectPtr<class UAkInitBank>             InitBank;                                          // 0x0308(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         MaxObstructionOcclusionPortalTraceDist2D;          // 0x0368(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36C[0x4];                                      // 0x036C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   SpawnAkAmbientSoundClass;                          // 0x0370(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   SpawnAkComponentClass;                             // 0x03A0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UAkAudioEvent>           MusicPlayEvent;                                    // 0x03D0(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           MusicSwitchesFolderPaths;                          // 0x0400(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSettings) == 0x000418, "Wrong size on UAkSettings");
...
static_assert(offsetof(UAkSettings, OcclusionIgnorePawnAttachedActors) == 0x000075, "Member 'UAkSettings::OcclusionIgnorePawnAttachedActors' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultFitToGeometryCollisionChannel) == 0x000076, "Member 'UAkSettings::DefaultFitToGeometryCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkSettings, AkGeometryMap) == 0x000078, "Member 'UAkSettings::AkGeometryMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, GlobalDecayAbsorption) == 0x0000C8, "Member 'UAkSettings::GlobalDecayAbsorption' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, EnvironmentDecayAuxBusMap) == 0x000100, "Member 'UAkSettings::EnvironmentDecayAuxBusMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, HFDampingName) == 0x000150, "Member 'UAkSettings::HFDampingName' has a wrong offset!");
static_assert(offsetof(UAkSettings, DecayEstimateName) == 0x000160, "Member 'UAkSettings::DecayEstimateName' has a wrong offset!");
static_assert(offsetof(UAkSettings, TimeToFirstReflectionName) == 0x000170, "Member 'UAkSettings::TimeToFirstReflectionName' has a wrong offset!");
static_assert(offsetof(UAkSettings, HFDampingRTPC) == 0x000180, "Member 'UAkSettings::HFDampingRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, DecayEstimateRTPC) == 0x0001B0, "Member 'UAkSettings::DecayEstimateRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, TimeToFirstReflectionRTPC) == 0x0001E0, "Member 'UAkSettings::TimeToFirstReflectionRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, AudioInputEvent) == 0x000210, "Member 'UAkSettings::AudioInputEvent' has a wrong offset!");
static_assert(offsetof(UAkSettings, AcousticTextureParamsMap) == 0x000240, "Member 'UAkSettings::AcousticTextureParamsMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, SplitSwitchContainerMedia) == 0x000290, "Member 'UAkSettings::SplitSwitchContainerMedia' has a wrong offset!");
static_assert(offsetof(UAkSettings, SplitMediaPerFolder) == 0x000291, "Member 'UAkSettings::SplitMediaPerFolder' has a wrong offset!");
static_assert(offsetof(UAkSettings, UseEventBasedPackaging) == 0x000292, "Member 'UAkSettings::UseEventBasedPackaging' has a wrong offset!");
static_assert(offsetof(UAkSettings, CommandletCommitMessage) == 0x000298, "Member 'UAkSettings::CommandletCommitMessage' has a wrong offset!");
static_assert(offsetof(UAkSettings, UnrealCultureToWwiseCulture) == 0x0002A8, "Member 'UAkSettings::UnrealCultureToWwiseCulture' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultAssetCreationPath) == 0x0002F8, "Member 'UAkSettings::DefaultAssetCreationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, InitBank) == 0x000308, "Member 'UAkSettings::InitBank' has a wrong offset!");
static_assert(offsetof(UAkSettings, AudioRouting) == 0x000338, "Member 'UAkSettings::AudioRouting' has a wrong offset!");
static_assert(offsetof(UAkSettings, bWwiseSoundEngineEnabled) == 0x00033C, "Member 'UAkSettings::bWwiseSoundEngineEnabled' has a wrong offset!");
static_assert(offsetof(UAkSettings, bWwiseAudioLinkEnabled) == 0x00033D, "Member 'UAkSettings::bWwiseAudioLinkEnabled' has a wrong offset!");
static_assert(offsetof(UAkSettings, bAkAudioMixerEnabled) == 0x00033E, "Member 'UAkSettings::bAkAudioMixerEnabled' has a wrong offset!");
static_assert(offsetof(UAkSettings, AskedToUseNewAssetManagement) == 0x00033F, "Member 'UAkSettings::AskedToUseNewAssetManagement' has a wrong offset!");
static_assert(offsetof(UAkSettings, bEnableMultiCoreRendering) == 0x000340, "Member 'UAkSettings::bEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, MigratedEnableMultiCoreRendering) == 0x000341, "Member 'UAkSettings::MigratedEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, FixupRedirectorsDuringMigration) == 0x000342, "Member 'UAkSettings::FixupRedirectorsDuringMigration' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseWindowsInstallationPath) == 0x000348, "Member 'UAkSettings::WwiseWindowsInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseMacInstallationPath) == 0x000358, "Member 'UAkSettings::WwiseMacInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, MaxObstructionOcclusionPortalTraceDist2D) == 0x000368, "Member 'UAkSettings::MaxObstructionOcclusionPortalTraceDist2D' has a wrong offset!");
static_assert(offsetof(UAkSettings, SpawnAkAmbientSoundClass) == 0x000370, "Member 'UAkSettings::SpawnAkAmbientSoundClass' has a wrong offset!");
static_assert(offsetof(UAkSettings, SpawnAkComponentClass) == 0x0003A0, "Member 'UAkSettings::SpawnAkComponentClass' has a wrong offset!");
static_assert(offsetof(UAkSettings, MusicPlayEvent) == 0x0003D0, "Member 'UAkSettings::MusicPlayEvent' has a wrong offset!");
static_assert(offsetof(UAkSettings, MusicSwitchesFolderPaths) == 0x000400, "Member 'UAkSettings::MusicSwitchesFolderPaths' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_31D[0x183];                                    // 0x031D(0x0183)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	ECollisionChannel GetOcclusionCollisionChannel();
	float GetPlaybackTime(int32 PlayingID);
	int32 PostAkEventAndWaitForEnd(class UAkAudioEvent* AkEvent, const class FString& In_EventName, const struct FLatentActionInfo& LatentInfo, bool bAllowPositionTracking);
...
static_assert(sizeof(UAkComponent) == 0x0004A0, "Wrong size on UAkComponent");
...
public:
	...
	uint8                                         Pad_2A9[0x5F];                                     // 0x02A9(0x005F)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkRoomComponent*                       FrontRoom;                                         // 0x0308(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAkRoomComponent*                       BackRoom;                                          // 0x0310(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAkPortalComponent, FrontRoom) == 0x000308, "Member 'UAkPortalComponent::FrontRoom' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, BackRoom) == 0x000310, "Member 'UAkPortalComponent::BackRoom' has a wrong offset!");
...
{
public:
	struct FWwiseAcousticTextureCookedData        AcousticTextureCookedData;                         // 0x0040(0x000C)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAcousticTexture) == 0x000050, "Wrong size on UAkAcousticTexture");
static_assert(offsetof(UAkAcousticTexture, AcousticTextureCookedData) == 0x000040, "Member 'UAkAcousticTexture::AcousticTextureCookedData' has a wrong offset!");
...
public:
	...
	bool                                          AsyncPost;                                         // 0x02C2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, SimpleDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C3[0x35];                                     // 0x02C3(0x0035)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AAkAmbientSound) == 0x0002F8, "Wrong size on AAkAmbientSound");
...
static_assert(offsetof(AAkAmbientSound, AsyncPost) == 0x0002C2, "Member 'AAkAmbientSound::AsyncPost' has a wrong offset!");
...
{
public:
	bool                                          AutoLoad;                                          // 0x0040(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkAudioBank, AutoLoad) == 0x000040, "Member 'UAkAudioBank::AutoLoad' has a wrong offset!");
...
{
public:
	float                                         MaxAttenuationRadius;                              // 0x0040(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsInfinite;                                        // 0x0044(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinimumDuration;                                   // 0x0048(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumDuration;                                   // 0x004C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWwiseLocalizedEventCookedData         EventCookedData;                                   // 0x0050(0x0060)(Edit, Transient, EditConst, NativeAccessSpecifierPublic)
...
public:
	...
	int32 PostOnComponentAndWait(class UAkComponent* Component, const bool bStopWhenAttachedObjectDestroyed, const struct FLatentActionInfo& LatentActionInfo, bool bAllowPositionTracking);
...
static_assert(sizeof(UAkAudioEvent) == 0x0000C0, "Wrong size on UAkAudioEvent");
static_assert(offsetof(UAkAudioEvent, MaxAttenuationRadius) == 0x000040, "Member 'UAkAudioEvent::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, IsInfinite) == 0x000044, "Member 'UAkAudioEvent::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MinimumDuration) == 0x000048, "Member 'UAkAudioEvent::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaximumDuration) == 0x00004C, "Member 'UAkAudioEvent::MaximumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, EventCookedData) == 0x000050, "Member 'UAkAudioEvent::EventCookedData' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, RequiredBank) == 0x0000B0, "Member 'UAkAudioEvent::RequiredBank' has a wrong offset!");
...
{
public:
	struct FWwiseGroupValueCookedData             GroupValueCookedData;                              // 0x0040(0x0014)(Edit, Transient, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        GroupShortId;                                      // 0x0054(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkGroupValue) == 0x000060, "Wrong size on UAkGroupValue");
static_assert(offsetof(UAkGroupValue, GroupValueCookedData) == 0x000040, "Member 'UAkGroupValue::GroupValueCookedData' has a wrong offset!");
static_assert(offsetof(UAkGroupValue, GroupShortId) == 0x000054, "Member 'UAkGroupValue::GroupShortId' has a wrong offset!");
...
static_assert(sizeof(UAkStateValue) == 0x000060, "Wrong size on UAkStateValue");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x0004D0, "Wrong size on UAkAudioInputComponent");
...
{
public:
	struct FWwiseLocalizedAuxBusCookedData        AuxBusCookedData;                                  // 0x0040(0x0060)(Edit, Transient, NativeAccessSpecifierPublic)
	class UAkAudioBank*                           RequiredBank;                                      // 0x00A0(0x0008)(ZeroConstructor, Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAuxBus) == 0x0000B0, "Wrong size on UAkAuxBus");
static_assert(offsetof(UAkAuxBus, AuxBusCookedData) == 0x000040, "Member 'UAkAuxBus::AuxBusCookedData' has a wrong offset!");
static_assert(offsetof(UAkAuxBus, RequiredBank) == 0x0000A0, "Member 'UAkAuxBus::RequiredBank' has a wrong offset!");
...
public:
	...
	static int32 ComponentSeekOnEvent(class UAkComponent* In_pComponent, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID);
	...
	static class UAkComponent* GetAkComponentEx(class USceneComponent* AttachToComponent, bool* ComponentCreated, class FName AttachPointName, const struct FVector& Location, EAttachLocation LocationType, float CreatedComponentOcclusionRefreshInterval, bool bCreatedComponentAutoDestroy);
	...
	static int32 SeekOnEvent(const class FString& In_EventName, class UAkComponent* In_pComponent, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID);
	...
	static void SetRTPCValueByPlayID(const class FString& RTPCName, float RTPCValue, int32 PlayID, int32 InterpolationTimeMs);
	...
	static class UAkComponent* SpawnAkComponentAtLocation(class UObject* WorldContextObject, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking);
	static class UAkComponent* SpawnAkComponentAtLocationEx(class UObject* WorldContextObject, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval);
	static class UAkComponent* SpawnAkComponentAttachedEx(class USceneComponent* BaseComponent, class UAkAudioEvent* AkEvent, const struct FVector& Location, const struct FRotator& Orientation, bool AutoPost, const class FString& EventName, bool AutoDestroy, bool bAllowPositionTracking, float OcclusionRefreshInterval);
...
static_assert(sizeof(UAkFolder) == 0x000040, "Wrong size on UAkFolder");
...
{
public:
	struct FWwiseLocalizedShareSetCookedData      ShareSetCookedData;                                // 0x0040(0x0060)(Edit, Transient, EditConst, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkEffectShareSet) == 0x0000A8, "Wrong size on UAkEffectShareSet");
static_assert(offsetof(UAkEffectShareSet, ShareSetCookedData) == 0x000040, "Member 'UAkEffectShareSet::ShareSetCookedData' has a wrong offset!");
...
{
public:
	struct FWwiseInitBankCookedData               InitBankCookedData;                                // 0x0040(0x0040)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkInitBank) == 0x000088, "Wrong size on UAkInitBank");
static_assert(offsetof(UAkInitBank, InitBankCookedData) == 0x000040, "Member 'UAkInitBank::InitBankCookedData' has a wrong offset!");
...
public:
	...
	bool                                          AsyncPost;                                         // 0x02D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, SimpleDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkRoomComponent, AsyncPost) == 0x0002D1, "Member 'UAkRoomComponent::AsyncPost' has a wrong offset!");
...
{
public:
	struct FWwiseGameParameterCookedData          GameParameterCookedData;                           // 0x0040(0x000C)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkRtpc) == 0x000050, "Wrong size on UAkRtpc");
static_assert(offsetof(UAkRtpc, GameParameterCookedData) == 0x000040, "Member 'UAkRtpc::GameParameterCookedData' has a wrong offset!");
...
static_assert(sizeof(UAkSwitchValue) == 0x000060, "Wrong size on UAkSwitchValue");
...
{
public:
	struct FWwiseTriggerCookedData                TriggerCookedData;                                 // 0x0040(0x000C)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkTrigger) == 0x000050, "Wrong size on UAkTrigger");
static_assert(offsetof(UAkTrigger, TriggerCookedData) == 0x000040, "Member 'UAkTrigger::TriggerCookedData' has a wrong offset!");
