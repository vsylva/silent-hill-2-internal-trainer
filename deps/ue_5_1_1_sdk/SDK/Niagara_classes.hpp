...
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageStreamingScale) == 0x000144, "Member 'UNiagaraSpriteRendererProperties::SubImageStreamingScale' has a wrong offset!");
