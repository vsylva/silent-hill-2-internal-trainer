...
void UBackgroundBlur::SetBlurMaskTexture(class UTexture2D* Texture)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BackgroundBlur", "SetBlurMaskTexture");

	Params::BackgroundBlur_SetBlurMaskTexture Parms{};
