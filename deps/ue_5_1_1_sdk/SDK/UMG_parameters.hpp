...
// Function UMG.BackgroundBlur.SetBlurMaskTexture
// 0x0008 (0x0008 - 0x0000)
struct BackgroundBlur_SetBlurMaskTexture final
{
public:
	class UTexture2D*                             Texture;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BackgroundBlur_SetBlurMaskTexture) == 0x000008, "Wrong alignment on BackgroundBlur_SetBlurMaskTexture");
static_assert(sizeof(BackgroundBlur_SetBlurMaskTexture) == 0x000008, "Wrong size on BackgroundBlur_SetBlurMaskTexture");
static_assert(offsetof(BackgroundBlur_SetBlurMaskTexture, Texture) == 0x000000, "Member 'BackgroundBlur_SetBlurMaskTexture::Texture' has a wrong offset!");
